...
from core_funtionality.data_loader import DataLoader
from core_funtionality.model import Model
...
def main():
    ...
    # plot_results_multiple(predictions, y_test, configs['data']['sequence_length'], name)
